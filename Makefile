...
modeling-acceptance-tests:
	cd activiti-cloud-acceptance-scenarios && \
	mvn -pl 'modeling-acceptance-tests' -q -Dlogging.level.root=off -Droot.log.level=off -Dspring.main.banner-mode=off -Dserenity.console.headings=minimal clean verify

runtime-acceptance-tests:
	cd activiti-cloud-acceptance-scenarios && \
	mvn -pl 'runtime-acceptance-tests' -q -Dlogging.level.root=off -Droot.log.level=off -Dspring.main.banner-mode=off -Dserenity.console.headings=minimal clean verify
